...
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `decorgloboom_db` ;
...
-- -----------------------------------------------------
-- Table `decorgloboom_db`.`comprobante`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `decorgloboom_db`.`comprobante` (
...
-- -----------------------------------------------------
-- Table `decorgloboom_db`.`tipo_cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `decorgloboom_db`.`tipo_cliente` (
...
-- -----------------------------------------------------
-- Table `decorgloboom_db`.`tipo_documento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `decorgloboom_db`.`tipo_documento` (
...
-- -----------------------------------------------------
-- Table `decorgloboom_db`.`Cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `decorgloboom_db`.`Cliente` (
  ...
  CONSTRAINT `fk_Cliente_tipo_cliente1`
    ...
    REFERENCES `decorgloboom_db`.`tipo_cliente` (`id_tipo_cliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Cliente_tipo_documento1`
    FOREIGN KEY (`id_tipo_documento`)
    REFERENCES `decorgloboom_db`.`tipo_documento` (`id_tipo_documento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `decorgloboom_db`.`ventas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `decorgloboom_db`.`ventas` (
...
--  INDEX `fk_ventas_comprobante1_idx` (`id_comprobante` ASC) VISIBLE,
  CONSTRAINT `fk_ventas_Cliente1`
    ...
    REFERENCES `decorgloboom_db`.`Cliente` (`id_cliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_ventas_comprobante1`
    ...
    REFERENCES `decorgloboom_db`.`comprobante` (`id_comprobante`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
--  INDEX `fk_producto_has_reserva_reserva1` (`id_venta` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_producto_has_reserva_reserva1`
    ...
    REFERENCES `decorgloboom_db`.`ventas` (`id_venta`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
