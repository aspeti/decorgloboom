    ...
    <ul class="navbar-nav ml-auto">
      ...
      <?php if($this->session->userdata('rol') == 1) { ?>  
        <li class="nav-item dropdown">
          <a class="nav-link navbar-purple" data-toggle="dropdown" href="#">
            Administrar
      ...
      <?php if($this->session->userdata('login')) { ?>   
        <li class="nav-item">
          <a href="<?php echo base_url();?>clientes" class="nav-link navbar-purple">
            <p>Clientes</p>
          </a>
        </li>   
        <li class="nav-item">
          <a href="<?php echo base_url();?>ventas" class="nav-link navbar-purple">
            <p>Ventas</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?php echo base_url();?>reportes" class="nav-link navbar-purple">
            <p>Reportes</p>
          </a>
        </li> 
        <li class="nav-item">
          <a href="<?php echo base_url();?>reportes/estadistica" class="nav-link navbar-purple">
            <p>Mas Vendidos</p>
          </a>
        </li>    
      <?php }?>     
